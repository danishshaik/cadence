...
const ICON_MAP: Record<string, SymbolName> = {
  ...
  people: { ios: "person.2.fill", android: "group" } as SymbolName,
  ...
  footprints: { ios: "figure.walk", android: "directions_walk" } as SymbolName,
  "book-open": { ios: "book", android: "menu_book" } as SymbolName,
  "message-circle": { ios: "message", android: "chat" } as SymbolName,
  "pen-line": { ios: "pencil", android: "edit" } as SymbolName,
  shield: { ios: "shield.fill", android: "shield" } as SymbolName,
